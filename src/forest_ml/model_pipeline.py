...
def _params_for_models(params: dict, grid_search: bool) -> dict:
    """
...
def create_pipeline(**params) -> Pipeline:
    ...
    if params["model"] == "RandomForestClassifier":
        clf = RandomForestClassifier(**_params_for_models(params=params, grid_search=False))
    elif params["model"] == "ExtraTreesClassifier":
        clf = ExtraTreesClassifier(**_params_for_models(params=params, grid_search=False))
    elif params["model"] == "KNeighborsClassifier":
        clf = KNeighborsClassifier(**_params_for_models(params=params, grid_search=False))
    else:
        clf = LogisticRegression(**_params_for_models(params=params, grid_search=False))
